...
function createDeepSeekPromptButton(searchButton, buttonArea, isChinese) {
  ...
  buttonContent.className = 'ds-button__content';
  ...
  textElement.textContent = isChinese ? '提示词' : 'Prompt';
  
  // 组装按钮
  buttonContent.appendChild(iconContainer);
  buttonContent.appendChild(cssIconContainer);
  ...
  promptButton.appendChild(buttonContent);
